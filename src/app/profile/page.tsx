...
import { Building, Phone, Store, Users } from "lucide-react";
    ...
    return (
        <article>
            <article className="w-full min-h-screen flex flex-col p-4">
                ...
                <article className="max-h-screen overflow-y-scroll border-2 border-red-600 flex flex-col md:flex-row gap-4 p-4 mt-4 rounded-lg">
                ...
                <article className="max-h-screen overflow-y-scroll border-2 border-red-600 flex flex-col md:flex-row gap-4 p-4 mt-4 rounded-lg">
                    ...
                    <article className="flex-1 flex gap-4 flex-col">
                        <Card className="size-full">
                            ...
                            <CardContent className="flex gap-4 justify-between items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 1024 1024" id="whatsapp">
                                    <defs>
                                ...
                                <Button variant="secondary" className="text-white font-semibold flex justify-between items-center gap-2"><Phone className=" text-primary" /><p>Ibu Cici</p></Button>
                            </CardContent>
                        </Card>
                        <Card className="size-full">
                            <CardContent className="flex gap-4 justify-between items-center">
