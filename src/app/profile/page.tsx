                ...
                <article className="max-h-screen overflow-y-scroll flex flex-col md:flex-row gap-4 p-4 mt-4 rounded-lg">
                    ...
                    <article className="flex-1 flex gap-4 flex-col">
                        <Card className="size-full">
                            ...
                            <CardContent className="flex gap-4 justify-between items-center">
                                <Link href={`https://wa.me/${formatPhoneForWhatsApp(profile.kontak)}`} className="w-full py-2 px-4 duration-500  hover:bg-gray-300 rounded-lg flex items-center gap-2">  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 1024 1024" id="whatsapp">
                                    <defs>
                                ...
                                </svg><section className="w-full flex gap-2 justify-between"><p>{formatPhoneDisplay(profile.kontak)}</p><span className="font-semibold">({profile.nama_kontak})</span></section></Link>
                            </CardContent>
                        </Card>
                        <Card className="size-full">
                            <CardContent className="flex gap-4 justify-between items-center">
                                <Button variant="ghost" className="size-full text-primary font-semibold" asChild>
                                    ...
                                    <p className="text-2xl font-bold text-primary text-nowrap">@dukuh_ngabean</p>
                                    </Link>
                                </Button>
                            </CardContent>
                        </Card>
